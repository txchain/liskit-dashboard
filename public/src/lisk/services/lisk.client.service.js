...
lisk.factory('LiskServices', ['$http', '$q', function($http, $q) {
    ...
    return {
        getBalance: function(address) {
            return $http.get('http://194.116.72.38:8000/api/accounts/getBalance?address='+address)
        ...
        getDelegateStats: function() {
            return $http.get('http://194.116.72.38:8000/api/delegates?getActive')
                .then(function(response) {
                    if (typeof response.data === 'object') {
                        return response.data;
                    } else {
        ...
        getVotesOfAccount: function(address) {
            return $http.get('http://194.116.72.38:8000/api/accounts/delegates/?address='+address)
                .then(function(response) {
                    if (typeof response.data === 'object') {
                        return response.data;
                    } else {
        ...
        getVoters: function(public_key) {
            return $http.get('http://194.116.72.38:8000/api/delegates/voters?publicKey='+public_key)
                .then(function(response) {
                    if (typeof response.data === 'object') {
                        return response.data;
                    } else {
        ...
        getPublicKey: function(address) {
            return $http.get('http://194.116.72.38:8000/api/accounts/getPublicKey?address='+address)
                .then(function(response) {
                    if (typeof response.data === 'object') {
                        return response.data;
                    } else {
        ...
        getAccount: function(address) {
            return $http.get('http://194.116.72.38:8000/api/accounts?address='+address)
                .then(function(response) {
                    if (typeof response.data === 'object') {
                        return response.data;
                    } else {
        ...
        getBlockChainHeight: function() {
            return $http.get('http://194.116.72.38:8000/api/blocks/getHeight')
                .then(function(response) {
                    if (typeof response.data === 'object') {
                        return response.data;
                    } else {
        ...
        getDelegates: function(offset) {
            return $http.get('http://194.116.72.38:8000/api/delegates?offset='+offset)
                .then(function(response) {
                    if (typeof response.data === 'object') {
                        return response.data;
                    } else {
